...
export default (props: {
  ...
  if (props.voterscount) {
    ranktext = props.stars.toLocaleString(z.lang.region, { maximumFractionDigits: 2 }) +
      "/" + NumAbbrev(props.voterscount, 2, z.lang.region)
  }
  ...
  return <f-c style={{ ...props.style, direction: "ltr" }}>
    ...
    {props.showrank ? <><sp-3 /><span style={{
      color: props.fontColor || "white", fontSize: props.fontSize || 10,
